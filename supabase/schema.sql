...
-- ============================================================
-- 기업·기술 자료 아카이브 (355-A)
-- contents(category='기업자료')의 문서 전용 1:1 메타 + 기업별 수집원
-- ============================================================
...
-- 초기 수집 대상. entities에 해당 기업이 있을 때만 안전하게 연결한다.
...
-- 지시서 B (2026-07-14) — 키워드 상세 LLM 핵심 인사이트 캐시 (키워드별 1일 1회 생성)
