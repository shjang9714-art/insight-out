...
import { Quote, TrendingUp, Building2, Tags } from 'lucide-react'
...
export default async function AiInsightsView() {
  ...
  const companyCardMap = new Map<string, CompanyCard>()
  ...
  // watchlistLower + isWatched 먼저 선언 후 classifiedKeywords 사용
